...
import com.brunomilitzer.reactive.sec09.helper.RevenueReport;
...
public class Lecture04Assignment {
    ...
    public static void main(String[] args) {
        ...
        bookStream().filter(book -> allowedCategories.contains(book.getCategory()))
                .buffer(Duration.ofSeconds(5)).map(list -> revenueCalculator(list))
